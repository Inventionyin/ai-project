...
def _mask_sensitive(detail: str) -> str:
...
async def create_issue_link(
    ...
    *,
    ...
    try:
        ...
        raise HTTPException(status_code=400, detail=_mask_sensitive(str(exc))) from exc
    except Exception as exc:  # pragma: no cover
        raise HTTPException(status_code=502, detail=_mask_sensitive(str(exc))) from exc
