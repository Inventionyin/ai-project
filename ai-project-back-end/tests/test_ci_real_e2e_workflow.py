...
def test_real_e2e_workflow_contains_required_ci_entrypoints():
    ...
    required_tokens = [
        ...
        "./scripts/verify_external_integrations.ps1 -Targets $env:EXTERNAL_SMOKE_TARGETS -EnableSmoke -FailOnSmokeError",
        "./scripts/verify_external_integrations.ps1 -Targets $env:EXTERNAL_SMOKE_TARGETS -EnableSmoke -EnableBusinessClosure -FailOnSmokeError",
