...
onMounted(async () => {
  ...
  startCreate()
  await Promise.all([loadRules(), loadDeliveries(), loadPromptTemplates(), loadGovernance(), loadStrategyCenter()])
})
</script>
        ...
        <div class="mt-4 grid grid-cols-1 gap-3">
          ...
          <div class="rounded-[8px] border border-black/10 p-3">
            ...
            <div class="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
              ...
              <label class="text-[12px] text-[#717182]">
                provider
                <input v-model="structuredRule.provider" class="mt-1 h-9 w-full rounded-[8px] border border-black/10 px-3 text-[13px] text-[#0A0A0A] outline-none" />
              </label>
